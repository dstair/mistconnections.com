...
$client->setScopes(array('https://apps-apis.google.com/a/feeds/user/'));

// Documentation: http://code.google.com/googleapps/domain/provisioning_API_v2_developers_guide.html
// Visit https://code.google.com/apis/console to generate your
// oauth2_client_id, oauth2_client_secret, and to register your oauth2_redirect_uri.
$client->setClientId('1073250724113.apps.googleusercontent.com');
$client->setClientSecret('fo_buXWglT-ipuA80HBZGbLY');
$client->setRedirectUri('http://www.mistconnections.com');
$client->setDeveloperKey('AIzaSyBGWmCmBKdItLVbzVCuoo0Zm17s3PiWwJY');
